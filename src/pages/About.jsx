...
export default function About() {
  return (
    <>
      ...
      <main className="bg-[#F6F3EC] pt-28 md:pt-36">
        ...
        <div className="mx-auto max-w-7xl px-5 md:px-6">
          ...
          >
            ...
            <div className="max-w-xl">
              ...
              >
                ...
                <p>
                  That's how <strong>PopFresh</strong> popped into life —
                  born out of midnight munchies, endless laughter, and a
                  shared love for guilt-free snacking.
                </p>

                <p>
                  We took the good old <strong>makhana</strong>, gave it a
                  modern twist, and turned it into the hero of snack time.
                  Light, tasty, and always fresh — just the way snacking
                  should be.
                </p>

                <p>
                  So go ahead — open, pop, and crunch your way into something
                  deliciously healthy. Because at{" "}
                  <strong>PopFresh</strong>, snacking isn't just a habit...
                </p>
          ...
          <section className="mt-24 text-center md:mt-32">
            ...
            <p
              ...
              "
            >
              Thoughtfully crafted snacks made with premium ingredients,
              clean recipes, and uncompromising quality.
            </p>
            ...
            >
              ...
              >
                ...
                <p
                  ...
                  "
                >
                  Every PopFresh pack begins with carefully sourced premium
                  makhana and thoughtfully selected ingredients to deliver
                  exceptional freshness, flavour, and quality.
                </p>
              ...
              >
                ...
                <p
                  ...
                  "
                >
                  We gently roast our makhana instead of frying it, giving
                  every bite a naturally light texture with the perfect
                  balance of crunch and flavour.
                </p>
              ...
              >
                ...
                <p
                  ...
                  "
                >
                  Every batch goes through strict quality checks so that
                  every pack you open is fresh, safe, and consistently
                  delicious.
                </p>
